...
import { runConfigShow, runConfigSet, runConfigReset, getConfigData } from './config.js';
...
describe('config command', () => {
  ...
  describe('runConfigSet', () => {
    ...
    describe('boolean fields', () => {
      ...
      it('should reject invalid boolean values', () => {
        ...
        expect(() => runConfigSet('includeDocIssues', 'maybe')).toThrow('Invalid boolean');
      });
    });
    ...
    describe('array fields', () => {
      ...
      it('should append with + prefix', () => {
        ...
        expect(result.languages).toEqual(['typescript', 'javascript', 'python']);
      });
      ...
      it('should remove with - prefix', () => {
        writeState(makeState({ languages: ['typescript', 'javascript', 'python'] }));
    ...
    describe('scope field', () => {
      ...
      it('should remove from scope with -', () => {
        writeState(makeState({ scope: ['beginner', 'intermediate', 'advanced'] }));
    ...
    describe('projectCategories field', () => {
      it('should set valid categories', () => {
        ...
        const result = runConfigSet('projectCategories', 'devtools, infrastructure');

        expect(result.projectCategories).toEqual(['devtools', 'infrastructure']);
      });
  ...
  describe('runConfigReset', () => {
    it('should reset preferences to defaults', () => {
      writeState(makeState({ githubUsername: 'custom', minStars: 999, languages: ['rust'] }));
